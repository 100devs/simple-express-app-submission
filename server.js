...
app.post('/addTask', (request, response) => {
    ...
    descriptionName: request.body.descriptionName, likes: 0})
    .then(result => {
...
app.put('/addOneLike', (request, response) => {
    db.collection('tasks').updateOne({taskName: request.body.taskNameS, descriptionName: request.body.descriptionNameS,likes: request.body.likesS},{
        $set: {
