...
app.post('/addCharacter', (request, response) => {
    ...
    bestCharacter: request.body.bestCharacter, likes: 0})
    .then(result => {
...
app.put('/addOneLike', (request, response) => {
    db.collection('movies').updateOne({movieName: request.body.movieNameS, bestCharacter: request.body.bestCharacterS,likes: request.body.likesS},{
        $set: {
